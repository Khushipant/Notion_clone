  ...
  export const Item = ({
    ...
    const onArchive = (
        ...
        toast.promise(promise, {
            ...
            success: 'Note Sucessfully Trashed!',
    ...
    return (
        ...
        className={cn(
            "group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground font-medium",
             active && "bg-primary/5 text-primary"
                ...
                {!!id && (
                    ...
                    >
                        <ChevronIcon className="h-4 2-4 shrink-0 text-muted-foreground"/>
                    </div>
                )}
                {documentIcon ?(
                    ...
                    <Icon className="shrink-0 h-[18px] mr-3 text-muted-foreground"/>
                )}
            ...
            {isSearch && (
                ...
                <span className="text-xs">⌘</span>Kfdfdf 
              </kbd>
            )}
            {!!id && (
